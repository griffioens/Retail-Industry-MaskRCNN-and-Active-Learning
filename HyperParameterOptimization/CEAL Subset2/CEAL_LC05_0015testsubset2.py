...
def create_model_and_train(iterator, outputdir, queue):
    ...
    DatasetCatalog.register("supermarket_train", lambda: get_combined_dict(["../supermarket_dataset/annotations/annotations/D2S_training.json", "../supermarket_dataset/annotations/annotations/D2S_augmented.json"], iterator.labeled_image_list, pseudolabelurl, pseudoimagenumbers))
...
if __name__ == '__main__':
    ...
    EXPERIMENTNAME = "cealLC05_0015testsubset2"
