...
if __name__ == '__main__':
    # CONSTANTS
    EXPERIMENTNAME = "experiment6"
    EPOCHS = 25
    LEARNING_RATE = 0.00025
    LEARNING_RATE_DECAY_STEP = [] #empty list if no decay, otherwise an iteratble with step numberw here to decay weight eg. (3000, ) will decay the weight at the 3000th iteration (with 2 images per iteration this is at image 6000)
    ...
    cfg.SOLVER.MAX_ITER = (image_count/2) * EPOCHS    
