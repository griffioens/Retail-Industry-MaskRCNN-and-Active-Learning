...
if __name__ == '__main__':
    ...
    EXPERIMENTNAME = "experiment24"
    outputdir = "output" + EXPERIMENTNAME
    os.makedirs(outputdir, exist_ok=True)


    # Registering the dataset
    DatasetCatalog.register("supermarket_train", lambda: get_combined_dict(["../supermarket_dataset/annotations/annotations/D2S_training.json", "../supermarket_dataset/annotations/annotations/D2S_augmented.json"], False))
    ...
    image_count = len(get_combined_dict(["../supermarket_dataset/annotations/annotations/D2S_training.json", "../supermarket_dataset/annotations/annotations/D2S_augmented.json"], False))
