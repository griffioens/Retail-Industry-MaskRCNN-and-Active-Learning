...
def create_model_and_train(iterator, outputdir, queue):
    ...
    DatasetCatalog.register("supermarket_unlabled", lambda: get_combined_dict(["../supermarket_dataset/annotations/annotations/D2S_training.json", "../supermarket_dataset/annotations/annotations/D2S_augmented.json"], iterator.unlabeled_image_list))
    list_classes = class_list("../supermarket_dataset/annotations/annotations/D2S_training.json")
