...
if __name__ == '__main__':
    ...
    EXPERIMENTNAME = "subset1_benchmark"
    outputdir = "output" + EXPERIMENTNAME
    os.makedirs(outputdir, exist_ok=True)


    # Registering the dataset
    DatasetCatalog.register("supermarket_train", lambda: get_combined_dict(["../supermarket_dataset/alteredannotations/D2S_training_newsplit.json", "../supermarket_dataset/alteredannotations/D2S_validation_newsplit.json"], False))
    ...
    image_count = len(get_combined_dict(["../supermarket_dataset/alteredannotations/D2S_training_newsplit.json", "../supermarket_dataset/alteredannotations/D2S_validation_newsplit.json"], False))
